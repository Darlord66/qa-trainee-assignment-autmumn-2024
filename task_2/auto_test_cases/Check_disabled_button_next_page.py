...
class TestButtonDisabled(unittest.TestCase):
    ...
    def test_button_disabled(self):
        link = self.browser.find_element(By.XPATH, '//*[@id="root"]/div/div[5]/div[1]/ul/li[8]/a')
        link.click()
        button = self.browser.find_element(By.XPATH, '//*[@id="root"]/div/div[5]/div[1]/ul/li[9]/button')
